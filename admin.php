        ...
        <table class="table table-bordered">
            ...
            while ($fila = $resultsquery->fetch()) {
                ...
                if($fila['imagen_avatar'] != null) {
                    echo '<img src="fotos/'.htmlspecialchars($fila['imagen_avatar']). '"with="5" alt="imagen-avatar"/>';
                }else {
                    echo "---";
                }
              ...
              </svg></a>'.'<a class="m-2" id="editar" href="actuser.php?id='.$fila['id'].'"><svg xmlns="http://www.w3.org/2000/svg" class="icon icon-tabler icon-tabler-trash" width="44" height="44" viewBox="0 0 24 24" stroke-width="1.5" stroke="#000000" fill="none" stroke-linecap="round" stroke-linejoin="round">
              <path stroke="none" d="M0 0h24v24H0z" fill="none"/>
              <path d="M4 7l16 0" />
              <path d="M10 11l0 6" />
              <path d="M14 11l0 6" />
